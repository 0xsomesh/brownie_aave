...
def main():
    ...
    tx.wait(1)
    print('deposited')
    available_borrow_eth, total_debt_eth = get_borrowable_data(
...
def repay_all(amount, lending_pool, account):
    ...
    tx = lending_pool.repay(config['networks'][network.show_active(
...
def get_borrowable_data(lending_pool, account):
    ...
    print(f"you have {available_borrow_eth} eth available")
